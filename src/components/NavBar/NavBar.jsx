    ...
    >
      <Stack direction={"row"} align={"center"}>
        ...
        <Flex
          ...
          flex={1}
        >
          <Icon color={"primaryDark"} w={5} h={5} as={ChevronRightIcon} />
        </Flex>
      </Stack>
    </Link>
  );
...
const MobileNavItem = ({ label, children, href }) => {
  ...
  return (
    <Stack spacing={4} onClick={children && onToggle}>
      ...
      <Collapse in={isOpen} animateopacity='true' style={{ marginTop: "0!important" }}>
        <Stack
          mt={2}
          pl={4}
          borderLeft={1}
          borderStyle={"solid"}
          borderColor={useColorModeValue("primaryDark", "primaryDark")}
          align={"start"}
        >
          {children &&
            children.map((child) => (
